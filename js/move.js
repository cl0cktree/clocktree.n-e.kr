$(function(){
	...
	function select_url(){
		if((this_url=='www.clocktree.co.kr/')||(this_url=='www.clocktree.co.kr/index.html')||(this_url=='www.clocktree.co.kr/sub/sub1.html')||(this_url=='www.clocktree.co.kr/sub/sub2.html')||(this_url=='www.clocktree.co.kr/sub/sub3.html')||(this_url=='www.clocktree.co.kr/sub/sub4.html')||(this_url=='www.clocktree.co.kr/sub/sub5.html')){
			...
			console.log('type_5 = '+portfolioindex_url);
		}else if((this_url=='http://www.clocktree.n-e.kr/')||(this_url=='http://www.clocktree.n-e.kr/index.html')||(this_url=='http://www.clocktree.n-e.kr/sub/sub1.html')||(this_url=='http://www.clocktree.n-e.kr/sub/sub2.html')||(this_url=='http://www.clocktree.n-e.kr/sub/sub3.html')||(this_url=='http://www.clocktree.n-e.kr/sub/sub4.html')||(this_url=='http://www.clocktree.n-e.kr/sub/sub5.html')){
			portfolioindex_url = 'http://www.clocktree.n-e.kr'
			console.log('type_6 = '+portfolioindex_url);
		}else if((this_url=='https://www.clocktree.n-e.kr/')||(this_url=='https://www.clocktree.n-e.kr/index.html')||(this_url=='https://www.clocktree.n-e.kr/sub/sub1.html')||(this_url=='https://www.clocktree.n-e.kr/sub/sub2.html')||(this_url=='https://www.clocktree.n-e.kr/sub/sub3.html')||(this_url=='https://www.clocktree.n-e.kr/sub/sub4.html')||(this_url=='https://www.clocktree.n-e.kr/sub/sub5.html')){
